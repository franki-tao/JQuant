...
import jquant.math.interpolations.MixedLinearCubicInterpolation;

public class MixedLinearCubic extends Interpolator {
    // fix below
    ...
    public Interpolation interpolate(double[] x, double[] y) {
        return new MixedLinearCubicInterpolation(x, y, n_, behavior_,
                da_, monotonic_,
